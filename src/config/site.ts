...
const links = {
  x: 'https://twitter.com/',
  github: 'https://github.com/annecrypted',
  githubAccount: 'https://github.com/annecrypted',
...
export const siteConfig = {
  name: 'spendr',
  description: 'spendr is the easiest way to keep track of your spendings',
  url: 'https://spendr.vercel.app',
  links,
  unsplash: {
    lobby,
    auth,
